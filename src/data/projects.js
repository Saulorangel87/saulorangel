...
export const projects = [
  {
    ...
    tags: ['ciclismo', 'planejamento', 'produto'], status: 'em evolução', url: 'https://cadencia.devsaulo.com.br/', visual: 'cadencia',
  },
  {
    ...
    tags: ['React', 'Go', 'SQLite', 'Docker'], status: 'em produção', url: 'https://estoque.devsaulo.com.br/', visual: 'estoque',
  },
  {
    ...
    tags: ['finanças', 'organização', 'produto'], status: 'em evolução', url: 'https://despesas.devsaulo.com.br/', visual: 'despesas',
  },
  {
